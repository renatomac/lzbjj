...
urlpatterns = [
    ...
    path("attendance/enroll/<int:member_id>/", views.attendance_enroll, name="attendance_enroll"),
    ...
    path("resetUserPassword/<int:user_id>/", views.resetUserPassword, name="resetUserPassword"),
    ...
    path("deletePromotion/<int:promotion_id>/", views.deletePromotion, name="deletePromotion"),
